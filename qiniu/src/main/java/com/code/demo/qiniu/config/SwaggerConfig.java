package com.code.demo.qiniu.config;
...
public class SwaggerConfig extends WebMvcConfigurationSupport implements EnvironmentAware {
    ...
    //api接口包扫描路径
    public static final String SWAGGER_SCAN_BASE_PACKAGE = "com.code.demo.qiniu.controller";
    public static final String VERSION = "1.0.0";

    public static final String GROUP_NAME = "qiniu-api";
    public static final String API_INFO_TITLE = "qiniu-api接口";

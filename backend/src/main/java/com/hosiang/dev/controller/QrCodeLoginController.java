...
import com.hosiang.dev.config.Receiver;
import com.hosiang.dev.config.WebSecurityConfig;
...
public class QrCodeLoginController {
    ...
    @Value("http://localhost:${server.port}/qrCodeLogin")
    private String domain;

    @Autowired
    private Receiver receiver;

    @Resource(name = "qrCodeRedisTemplate" )
    private StringRedisTemplate redisTemplate;

    @GetMapping({"/", "index"})
    public String index(Model model, @SessionAttribute(WebSecurityConfig.SESSION_KEY) String user) {
        model.addAttribute("user", user);
        return "qrCodeLogin/index";
    }

    @GetMapping("login")
    public String login() {
        return "qrCodeLogin/login";
    }
    ...
    Map<String, Object> getQrCode() throws Exception {
        ...
        // app端登录地址
        String loginUrl = domain+"/login/setUser/loginId/";
    ...
    public @ResponseBody
    Map<String, Object> setUser(@PathVariable String loginId, @PathVariable String user) {

package com.code.demo.wxjspay.config;
...
public class SwaggerConfig extends WebMvcConfigurationSupport implements EnvironmentAware {
    ...
    //api接口包扫描路径
    public static final String SWAGGER_SCAN_BASE_PACKAGE = "com.code.demo.wxjspay.controller";
    public static final String VERSION = "1.0.0";

    public static final String GROUP_NAME = "wxjspay";
    public static final String API_INFO_TITLE = "wxjspay接口";
    public static final String API_INFO_DESCRIPTION = "wxjspay接口描述";

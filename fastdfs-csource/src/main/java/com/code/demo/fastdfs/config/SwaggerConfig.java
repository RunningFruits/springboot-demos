package com.code.demo.fastdfs.config;
...
public class SwaggerConfig extends WebMvcConfigurationSupport implements EnvironmentAware {
    ...
    //api接口包扫描路径
    public static final String SWAGGER_SCAN_BASE_PACKAGE = "com.code.demo.fastdfs.controller";
    public static final String GROUP_NAME = "fastdfs-csource";
    public static final String API_INFO_TITLE = "fastdfs分布式文件上传";
    ...
    public void addCorsMappings(CorsRegistry registry) {
        registry.addMapping("/fastdfs-csource/**")
                .allowedMethods("*")
                .allowedOrigins("*")
                .allowedHeaders("*");
    }

...
(function () {
    ...
    var Swiper = function (container, params) {
        ...
        var defaults = {
            ...
            paginationBulletMessage: 'Go to slide {{extra}}',
            // Callbacks
        ...
        s.updateClickedSlide = function (e) {
            ...
            if (s.params.slideToClickedSlide && s.clickedIndex !== undefined && s.clickedIndex !== s.activeIndex) {
                ...
                if (s.params.loop) {
                    ...
                    realIndex = $(s.clickedSlide).attr('data-swiper-slide-extra');
                    if (s.params.centeredSlides) {
                        if ((slideToIndex < s.loopedSlides - s.params.slidesPerView/2) || (slideToIndex > s.slides.length - s.loopedSlides + s.params.slidesPerView/2)) {
                            s.fixLoop();
                            slideToIndex = s.wrapper.children('.' + s.params.slideClass + '[data-swiper-slide-extra="' + realIndex + '"]:not(.swiper-slide-duplicate)').eq(0).index();
                            setTimeout(function () {
        ...
        s.onTouchMove = function (e) {
            ...
            // Update active extra in free mode
        ...
        s.createLoop = function () {
            ...
            slides.each(function (index, el) {
                ...
                slide.attr('data-swiper-slide-extra', index);
            });
        ...
        s.destroyLoop = function () {
            s.wrapper.children('.' + s.params.slideClass + '.' + s.params.slideDuplicateClass).remove();
            s.slides.removeAttr('data-swiper-slide-extra');
        };
                ...
                img.each(function () {
                    ...
                    s.loadImage(_img[0], (src || background), srcset, false, function () {
                        ...
                        if (s.params.loop && loadInDuplicate) {
                            var slideOriginalIndex = slide.attr('data-swiper-slide-extra');
                            if (slide.hasClass(s.params.slideDuplicateClass)) {
                                var originalSlide = s.wrapper.children('[data-swiper-slide-extra="' + slideOriginalIndex + '"]:not(.' + s.params.slideDuplicateClass + ')');
                                s.lazy.loadImageInSlide(originalSlide.index(), false);
                            }
                            else {
                                var duplicatedSlide = s.wrapper.children('.' + s.params.slideDuplicateClass + '[data-swiper-slide-extra="' + slideOriginalIndex + '"]');
        ...
        function handleMousewheel(e) {
            ...
            if (!s.params.freeMode) {
                ...
                // Return wxpage scroll on edge positions
  ...
  Photos.prototype = {
    ...
    slideTo: function(index, duration) {
      ...
      this.doWrapperTransform(duration, $.proxy(function() {
        if(this.lastActiveIndex === this.activeIndex) return false; // active extra not change
  ...
  defaults = Photos.prototype.defaults = {
    ...
    tpl: '<div class="weui-photo-browser-modal">\
            <div class="swiper-container">\
              ...
              <div class="caption">\
                {{#items}}\
                <div class="caption-item caption-item-{{@extra}}">{{caption}}</div>\
                {{/items}}\
              </div>\

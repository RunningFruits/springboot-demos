...
public class SwaggerConfig extends WebMvcConfigurationSupport implements EnvironmentAware {
    ...
    //api接口包扫描路径
    public static final String SWAGGER_SCAN_BASE_PACKAGE = "com.firealarm.controller";
    public static final String VERSION = "1.0.0";

    public static final String GROUP_NAME = "easypoi";
    public static final String API_INFO_TITLE = "easypoi接口";
    public static final String API_INFO_DESCRIPTION = "easypoi接口描述";

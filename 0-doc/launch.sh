...
start)
        ## 启动eureka
        echo "--------eureka 开始启动--------------"
        nohup java -Xms512m -Xmx512m -jar $EUREKA >/dev/null 2>&1 &
        ...
        ## 启动GZGL
        echo "--------开始启动GZGL---------------"
        nohup java -Xms512m -Xmx512m -jar $GZGL >/dev/null 2>&1 &
		...
		## 启动COLLECTER
        echo "--------开始启动COLLECTER---------------"
        nohup java -Xms512m -Xmx512m -jar $COLLECTER >/dev/null 2>&1 &
		...
		## 启动ZDMB
        echo "--------开始启动ZDMB---------------"
        nohup java -Xms512m -Xmx512m -jar $ZDMB >/dev/null 2>&1 &
		...
		## 启动XTSZ
        echo "--------开始启动XTSZ---------------"
        nohup java -Xms512m -Xmx512m -jar $XTSZ >/dev/null 2>&1 &
		...
		## 启动QBSJ
        echo "--------开始启动QBSJ---------------"
        nohup java -Xms512m -Xmx512m -jar $QBSJ >/dev/null 2>&1 &
		...
		## 启动FILE
        echo "--------开始启动FILE---------------"
        nohup java -Xms512m -Xmx512m -jar $FILE >/dev/null 2>&1 &
		...
		## 启动PTAQ
        echo "--------开始启动PTAQ---------------"
        nohup java -Xms512m -Xmx512m -jar $PTAQ >/dev/null 2>&1 &
		...
		## 启动QYXZ
        echo "--------开始启动QYXZ---------------"
        nohup java -Xms512m -Xmx512m -jar $QYXZ >/dev/null 2>&1 &
		...
		## 启动FXPG
        echo "--------开始启动FXPG---------------"
        nohup java -Xms512m -Xmx512m -jar $FXPG >/dev/null 2>&1 &
		...
		## 启动OPEN
        echo "--------开始启动OPEN---------------"
        nohup java -Xms512m -Xmx512m -jar $OPEN >/dev/null 2>&1 &

...
$('.arrow-left').on('click', function () {
    window.location.href = contextPath + '/wxpage/wxpage/detail';
});
$('.buyNotice').on('click', function () {
    window.location.href = contextPath + '/wxpage/wxpage/buyNotice';
});
    ...
    WeixinJSBridge.invoke(
        ...
        function (res) {
            ...
            if (res.err_msg == "get_brand_wcpay_request:ok") {
                ...
                // 但并不保证它绝对可靠。
                $.toast("支持成功");
                window.location.href = contextPath + "/wxpage/list";
